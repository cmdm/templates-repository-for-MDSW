...
I also added the templates for validation of software QMS tools and software in production equipment.
...
- Coding, coding, coding and coding,
- Vertification (Unit tests, integration tests, verification tests),
- Validation,
- Release
